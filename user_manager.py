...
class UserManager:
    ...
    def __init__(self, auth_mode: str = None, users_file: str = None):
    ...
    def _load_users_from_file(self):
        ...
        if not os.path.exists(self.users_file):
            logger.warning(f"Users file {self.users_file} not found. No users authorized.")
            return
        ...
        try:
            ...
            logger.info(f"User-scoped mode: {len(self.users)} users loaded from {self.users_file}")
...
def get_user_manager() -> UserManager:
    ...
    if _user_manager is None:
        ...
        _user_manager = UserManager(auth_mode=auth_mode)
